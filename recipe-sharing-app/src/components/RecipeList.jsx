  ...
  return (
    <div style={{ marginTop: '30px', display: 'flex', flexDirection: 'column', gap: '18px' }}>
      {recipes.length === 0 ? (
        ...
        recipes.map(recipe => (
          <div key={recipe.id} style={{ background: '#18181b', color: '#fff', borderRadius: '10px', boxShadow: '0 2px 12px rgba(0,0,0,0.10)', padding: '20px 24px', border: '1px solid #333', display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
